...
import static com.dungle1310.personalnotes.NotesContract.Notes.buildNoteUri;
...
public class AppProvider extends ContentProvider {
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (match) {
            case NOTES:
                ...
                return buildNoteUri(String.valueOf(noteRecordId));
            case ARCHIVES:
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            case NOTES_ID:
                String noteId = NotesContract.Notes.getNoteId(uri);
                String noteSelectionCriteria = BaseColumns._ID + "=" + noteId
                        + (!TextUtils.isEmpty(selection) ? " AND ( " + selection + ")" : "");
                return db.delete(AppDatabase.Tables.NOTES, noteSelectionCriteria, selectionArgs);
            case ARCHIVES_ID:
                String archiveId = ArchivesContract.Archives.getArchiveId(uri);
