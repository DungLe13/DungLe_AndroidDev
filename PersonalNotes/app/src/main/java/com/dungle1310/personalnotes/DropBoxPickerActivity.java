...
/**
 * Created by Dung on 1/30/2017.
 */

public class DropBoxPickerActivity extends BaseActivity
        implements DropBoxDirectoryListenerAsync.OnLoadFinished, DropBoxDirectoryCreatorAsync.OnDirectoryCreateFinished {
    ...
    private void setUpBar() {
        TextView logoutTV = (TextView) findViewById(R.id.logout_dropbox_label);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerItemClickListener(this, recyclerView,
                new RecyclerItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        ...
                        new DropBoxDirectoryListenerAsync(getApplicationContext(), mApi, getCurrentPath(),
        ...
        if (mAfterAuth) {
            ...
            if (session.authenticationSuccessful()) {
                try {
                    ...
                    showToast("Could not authenticate Dropbox " + e.getLocalizedMessage());
                }
            }
        }
    }
