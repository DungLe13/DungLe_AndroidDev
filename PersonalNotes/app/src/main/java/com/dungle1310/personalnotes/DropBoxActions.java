...
public class DropBoxActions {
    public static void loadAuth(AndroidAuthSession session, Context context) {
        SharedPreferences pref = context.getSharedPreferences(AppConstant.ACCOUNT_PREFS_NAME, 0);
        String key = pref.getString(AppConstant.ACCESS_KEY_NAME, null);
        String secret = pref.getString(AppConstant.ACCESS_SECRET_NAME, null);
