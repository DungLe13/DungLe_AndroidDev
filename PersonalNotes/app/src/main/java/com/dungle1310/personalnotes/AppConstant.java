...
public class AppConstant {
    ...
    //drop box
    public static final String APP_KEY = "nv2nj26c63cz73g";//change this with drop box key
    public static final String APP_SECRET = "zhn5taq8pv66cp0";//change this with drop box secret key
