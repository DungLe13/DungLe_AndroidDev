...
public class AppDatabase extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE " + Tables.NOTES + " ("
                ...
                + NotesContract.NoteColumns.NOTES_TITLE + " TEXT NOT NULL,"
                + NotesContract.NoteColumns.NOTES_DESCRIPTION + " TEXT NOT NULL,"
                + NotesContract.NoteColumns.NOTES_TIME + " TEXT NOT NULL,"
                + NotesContract.NoteColumns.NOTES_TYPE + " TEXT NOT NULL,"
                + NotesContract.NoteColumns.NOTES_IMAGE_STORAGE_SELECTION + " INTEGER NOT NULL,"
                + NotesContract.NoteColumns.NOTES_IMAGE + " TEXT NOT NULL,"
                + NotesContract.NoteColumns.NOTES_DATE + " TEXT NOT NULL)");
