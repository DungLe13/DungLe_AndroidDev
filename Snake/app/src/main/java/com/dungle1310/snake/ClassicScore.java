...
import static com.dungle1310.snake.R.layout.content_classic_score;
...
public class ClassicScore extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(content_classic_score);
        ...
        // AdRequest adRequest = new AdRequest.Builder().build();    // For publishing app
